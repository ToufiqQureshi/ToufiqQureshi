...
[![Blog](https://img.shields.io/badge/Blog-FFC107?style=for-the-badge&logo=hashnode&logoColor=black)](https://neurofiq.in)
...
![Languages](https://skills.syvixor.com/api/icons?i=js,py,html,css)

### 🚀 **Frameworks & Libraries**

![Frameworks](https://skills.syvixor.com/api/icons?i=huggingface,langchain,fastapi,reactjs,Crewai)
...
![Cloud](https://skills.syvixor.com/api/icons?perline=15&i=amazonwebservices,googlecloud,azure,railway,digitalocean)

### 🗄️ **Databases & Storage**

![Database](https://skills.syvixor.com/api/icons?perline=15&i=postgresql,mysql,,mongodb,redis,sqlite)

### 🔄 **DevOps & CI/CD**

![Devops](https://skills.syvixor.com/api/icons?perline=15&i=docker,kubernetes,grafana,prometheus,gitlab)
...
![Monitoring](https://skills.syvixor.com/api/icons?i=elasticsearch,opentelemetry,grafana,prometheus)
